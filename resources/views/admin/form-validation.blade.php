                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-text">Form validation styles are also available for bootstrap
                                    custom form controls.</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm">
                                        <form class="was-validated">
                                            <div class="custom-control custom-checkbox mb-3">
                                                ...
                                                <label class="custom-control-label"
                                                    for="customControlValidation1">Check this custom checkbox</label>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-text">You can swap the <code>.{valid|invalid}-feedback</code>
