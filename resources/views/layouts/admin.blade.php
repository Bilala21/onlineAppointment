...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{url('admin_assets/img/favicon.png')}}">
...
<body>
        ...
        <div class="header">
            ...
            <div class="header-left">
                ...
                <a href="index.html" class="logo logo-small">
                    <img src="{{url('admin_assets/img/logo-small.png')}}" alt="Logo" width="30" height="30">
                </a>
            </div>
            <!-- /Logo -->
            ...
            <ul class="nav user-menu">
                                        ...
                                        <div class="media">
                                            <span class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle" alt="User Image"
                                                    src="{{url('admin_assets/img/doctors/doctor-thumb-01.jpg')}}">
                                            </span>
                                ...
                                <li class="notification-message">
                                    <a href="#">
                                        <div class="media">
                                            <span class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle" alt="User Image"
                                                    src="{{url('assets/img/patients/patient1.jpg')}}">
                                            </span>
                                            <div class="media-body">
                                ...
                                <li class="notification-message">
                                    <a href="#">
                                        <div class="media">
                                            <span class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle" alt="User Image"
                                                    src="{{url('assets/img/patients/patient2.jpg')}}">
                                            </span>
                                            <div class="media-body">
                                ...
                                <li class="notification-message">
                                    <a href="#">
                                        <div class="media">
                                            <span class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle" alt="User Image"
                                                    src="a{{url('assets/img/patients/patient3.jpg')}}">
                                            </span>
                                            <div class="media-body">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <span class="user-img"><img class="rounded-circle" src="{{url('admin_assets/img/profiles/avatar-01.jpg')}}"
                                width="31" alt="Ryan Taylor"></span>
                    </a>
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="{{url('admin_assets/img/profiles/avatar-01.jpg" alt="User Image')}}"
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="{{route('appointment')}}"><i class="fe fe-layout"></i> <span>Appointments</span></a>
                        </li>
                        <li>
	...
	<!-- jQuery -->
	<script src="{{url('admin_assets/js/bootstrap.min.css')}}"></script>

	<!-- Bootstrap Core JS -->
	<script src="{{url('admin_asseste/js/popper.min.js')}}"></script>
	<script src="{{url('admin_asseste/js/bootstrap.min.js')}}"></script>

	<!-- Slimscroll JS -->
	<script src="{{url('admin_asseste/plugins/slimscroll/jquery.slimscroll.min.js')}}"></script>

	<script src="{{url('admin_asseste/plugins/raphael/raphael.min.js')}}"></script>
	<script src="{{url('admin_asseste/plugins/morris/morris.min.js')}}"></script>
	<script src="{{url('admin_asseste/js/chart.morris.js')}}"></script>

	<!-- Custom JS -->
	<script src="{{url('admin_asseste/js/script.js')}}"></script>
